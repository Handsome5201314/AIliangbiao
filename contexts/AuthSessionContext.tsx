...
import {
  clearAgentpitSsoAttempted,
  redirectToAgentpitSso,
  shouldAutoAgentpitSso,
} from '@/lib/agentpit-sso';
import { clearGuestSessionId } from '@/lib/utils/guestSession';
...
export function AuthSessionProvider({ children }: { children: ReactNode }) {
  ...
  const refresh = useCallback(async () => {
    ...
    if (!currentToken) {
      ...
      if (shouldAutoAgentpitSso()) {
        redirectToAgentpitSso(window.location.pathname + window.location.search);
      }
