...
export const skillHttpRoutes: SkillRouteDescriptor[] = [
  ...
  { method: 'POST', path: '/v1/scales/:scaleId/sessions', summary: 'Create an assessment session', auth: 'agent', scope: 'skill:scales:evaluate' },
  { method: 'GET', path: '/v1/scales/sessions/:sessionId', summary: 'Get assessment session state', auth: 'agent', scope: 'skill:scales:read' },
  { method: 'POST', path: '/v1/scales/sessions/:sessionId/answer', summary: 'Submit one answer to an assessment session', auth: 'agent', scope: 'skill:scales:evaluate' },
  { method: 'POST', path: '/v1/scales/sessions/:sessionId/back', summary: 'Move back one question in an assessment session', auth: 'agent', scope: 'skill:scales:evaluate' },
  { method: 'POST', path: '/v1/scales/sessions/:sessionId/cancel', summary: 'Cancel an assessment session', auth: 'agent', scope: 'skill:scales:evaluate' },
