...
export const skillHttpRoutes: SkillRouteDescriptor[] = [
  ...
  { method: 'POST', path: '/v1/scales/:scaleId/sessions', summary: 'Create or resume assessment session', auth: 'agent', scope: 'skill:scales:evaluate' },
  { method: 'GET', path: '/v1/scales/:scaleId/sessions/:sessionId', summary: 'Get assessment session state', auth: 'agent', scope: 'skill:scales:read' },
  { method: 'DELETE', path: '/v1/scales/:scaleId/sessions/:sessionId', summary: 'Cancel assessment session', auth: 'agent', scope: 'skill:scales:evaluate' },
