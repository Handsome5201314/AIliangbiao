export function buildMcpManifest() {
  return {
    ...
    tools: [
      { name: 'list_supported_scales', scope: 'skill:scales:read' },
      { name: 'get_scale_schema', scope: 'skill:scales:read' },
      { name: 'map_natural_language_answer', scope: 'skill:scales:read' },
      { name: 'confirm_mapped_answer', scope: 'skill:scales:evaluate' },
      { name: 'score_assessment', scope: 'skill:scales:evaluate' },
      ...
      { name: 'list_scales', scope: 'skill:scales:read' },
      { name: 'submit_and_evaluate', scope: 'skill:scales:evaluate' },
      { name: 'submit_assessment', scope: 'skill:scales:evaluate' },
