...
export type VoiceSessionMode = "manual" | "voice_guided" | "full_voice" | "call_mode";
export type VoiceState = "idle" | "assistant_speaking" | "user_listening" | "understanding" | "confirming" | "timeout_reprompt" | "fallback_prompt" | "paused" | "navigating" | "handoff_to_manual" | "completed";
export type VoiceIntent = "answer" | "irrelevant" | "pause" | "repeat" | "previous" | "change_answer" | "resume" | "explain" | "skip" | "quit" | "switch_member" | "switch_language" | "slower" | "faster" | "risk_escalation";
export type ScaleCategory = "Child Development" | "Mental Health" | "Personality" | "Career Assessment" | "Cognitive Health" | "General Health";
